...
public class BuzzFeedQuiz implements GameWriteable{
        static Scanner sc = new Scanner(System.in);
        
public boolean isHighScore(String score, String currentHighScore){
        int currentScore = Integer.valueOf(score);
        int highScore = Integer.valueOf(currentHighScore);
...
public void play(){
        ...
        public static void gameIntro() {
                ...
                if (play != 67) {
                        System.out.println("I'LL GIVE YOU ONE MORE CHANCE. PLEASE TYPE '67' TO START.");
                        gameIntro();
                }
        }
